...
describe("chatting", () => {
  ...
  describe("getChattings", () => {
    it("성공", async () => {
      ...
      chattingRepository.getNoReadMessage = jest.fn(() => {
        return { number: 1 };
      });
    ...
    it("실패 : catch error", async () => {
      ...
      const response = httpMocks.createResponse();
      const chattingList = [];
      chattingRepository.getChattings = jest.fn(() => {
        throw new Error();
      });
  ...
  describe("joinRoom", () => {
    it("성공", async () => {
      ...
      const response = httpMocks.createResponse();
      chattingController.createChatting = () => {
        return "chat1";
      };
    ...
    it("실패 : catch error", async () => {
      ...
      const response = httpMocks.createResponse();
      chattingController.createChatting = jest.fn(() => {
        throw new Error();
      });
  ...
  describe("createChatting", () => {
    ...
    it("실패 : catch error", async () => {
      ...
      const result = {};
      chattingRepository.insertInChattingList = () => chatListId;
      chattingRepository.createchattingRoom = () => {
        throw new Error();
      };
      chattingRepository.cancelChattingList = jest.fn();
  ...
  describe("sendMessage", () => {
    ...
    it("실패 : catch error", async () => {
      ...
      chattingRepository.saveChatting = () => {
        throw new Error();
      };
      chattingRepository.getNewChattingById = () => chatting;
      chattingRepository.getPlayersSocketId = () => playerList;
  ...
  describe("getMessages", () => {
    it("성공 : 기존에 저장된 메시지들을 받기 위한 경우", async () => {
      ...
      await chattingController.getMessages(request, response);
  ...
  describe("getNewMessage", () => {
    it("성공", async () => {
      ...
      await chattingController.getNewMessage(request, response);
    ...
    it("실패 : catch error", async () => {
      ...
      const response = httpMocks.createResponse();
      const chatting = [{ chatting_id: 1 }];
      chattingRepository.getNewChatting = jest.fn(() => {
        throw new Error();
      });
      chattingRepository.updateNewChatting = jest.fn();
  ...
  describe("validationCheck", () => {
    it("성공", async () => {
      const request = httpMocks.createRequest({
        ...
        body: {
          ...
          readAMsg: true,
          socketId: "socketId",
          chattingUser: "customer",
        },
      });
      const response = httpMocks.createResponse();
      const next = jest.fn();

      await chattingController.validationCheck(request, response, next);

      expect(next).toHaveBeenCalledTimes(1);
    });

    it("실패: uniquId가 없는 경우", async () => {
      const request = httpMocks.createRequest({
        username: "testUser",
        params: {
          id: "chat1",
    ...
    it("실패 : 메시지 읽음 표시가 boolean이 아닌 경우", async () => {
      const request = httpMocks.createRequest({
        username: "testUser",
        params: {
          id: "chat1",
    ...
    it("실패 : 채팅을 보낸이가 customer 및 master가 아닌 경우", async () => {
      const request = httpMocks.createRequest({
        username: "testUser",
        params: {
          id: "chat1",
